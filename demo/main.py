...
def main():
    ...
    # apptype_train_term_doc = sparse.vstack((apptype_train_term_doc, apptype_train_classification))
    # app_desc_term_doc = sparse.vstack((app_desc_term_doc, app_desc_classification))
    # print('添加了类别特征 耗时： %s \n' % str(time.clock() - start))
